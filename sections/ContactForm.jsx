  ...
  return (
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        ...
        <TypingText title="Contact Form" textStyles="text-center" />
        <TitleText
          title={(
        ...
        >
          ...
          <form onSubmit={formik.handleSubmit} className='w-full lg:w-3/4 mx-auto overflow-hidden rounded-[32px] p-8 rounded-[32px] border-[1px] border-[#6A6A6A]'>
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6">
                <label className={`block font-normal sm:text-[14px] text-[14px] sm:leading-[30px] leading-[30px] text-white ${formik.touched.message && formik.errors.message ? 'text-red-500' : ''}`}
                  htmlFor="message"
                >
