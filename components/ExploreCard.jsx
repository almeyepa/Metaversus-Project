...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    <img
      src={imgUrl}
      alt="planet-04"
      className="absolute w-full h-full object-cover rounded-[24px] brightness-75 hover:brightness-50 ease-in-out transition-all"
    />
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col rounded-b-[24px]">
        ...
        >
          <img
            src="/headset.svg"
            alt="headset"
            className="w-1/2 h-1/2 object-contain brightness-150"
          />
        </Link>
